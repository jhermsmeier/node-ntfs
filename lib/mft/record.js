...
/**
 * Reads a unsigned 64 bit integer from a buffer
 * @param  {Buffer} buffer
 * @param  {Number} offset
 * @return {Number}
 */
...
MFTRecord.prototype = {
  ...
  parseHeader: function( buffer ) {
    ...
    this.baseRecord       = readUInt64LE( buffer, 32 )
  ...
  toBuffer: function() {
    ...
    buffer.writeUInt64LE( this.lsn,                8 )
    ...
    buffer.writeUInt64LE( this.baseRecord,        32 )
