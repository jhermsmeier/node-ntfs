...
MFTRecord.prototype = {
  ...
  parseHeader: function( buffer ) {
    ...
    this.lsn              = int64.readInt64LE( buffer, 8 )
    ...
    // this.baseRecord = int64.readUInt64LE( buffer, 32 )
  ...
  toBuffer: function() {
    ...
    int64.writeUInt64LE( this.lsn, buffer,         8 )
    ...
    int64.writeUInt64LE( this.baseRecord, buffer, 32 )
